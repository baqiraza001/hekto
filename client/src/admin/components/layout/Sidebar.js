...
const drodownsList = [
  ...
  },
  {
    title: 'Users',
    icon: <ListIcon />,
    items: [{ to: '/admin/users', text: 'Users', icon: <ListIcon />}, { to: '/admin/users/add', text: 'Add user', icon: <AddCircleOutline />}]
  }
];
...
export default function Sidebar() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} sx={{ backgroundColor: "var(--purple)" }}>
        <Toolbar>
          <IconButton
            color="inherit"
